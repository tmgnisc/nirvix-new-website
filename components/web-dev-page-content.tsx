...
import { webDevFaqItems, webDevPricingPlans } from "@/lib/web-development-service-data";
    ...
    <>
      <main id="top" className="w-full overflow-x-clip">
        ...
        <PricingSection
          ...
          title="Website Development Packages and Pricing in Nepal"
          subtitle="Fixed-scope project pricing, not a vague hourly rate. Every website we build ships with a domain and hosting free for the first year."
